...
namespace ASPNET.StarterKit.Commerce {
    ...
    public class AddToCart : System.Web.UI.Page {
        ...
        private void Page_Load(object sender, System.EventArgs e) {
            ...
            if (Request.Params[IBuySpyCommon.Strings.QueryStrings.ProductId] != null) {
                ...
                cart.AddItem(cartId, Int32.Parse(Request.Params[IBuySpyCommon.Strings.QueryStrings.ProductId]), 1);
            }  
