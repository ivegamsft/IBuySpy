            ...
            while ( (line = sr.ReadLine()) != null ) {
                ...
                if (list.Length > 1) {
                    ...
                    for (int i=0; i< sourcelist.Length; i++) {
                        ...
                        sb.Append("<a class='white' target=docFrame href='" + (Request.ApplicationPath=="/"?"":Request.ApplicationPath) + "/docs/" + item.HRef + "'>");
                ...
                <tr valign="top">
                    <td>
                        ...
                        <table cellpadding=5 cellspacing=0 background="grid_background.gif"  width="100%">
                            <tr>
                                <td class="TitleBar">
                                    <span id="Title" class="SourceViewTitle" runat="server">ASP.NET Commerce Starter Kit Source Code Viewer</span>
                                </td>
                            </tr>
                        </table>
