...
Param(
    ...
    [string] $ResourceGroupName = 'ASP.NETCommerceStarterKit_CSVS_',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = 'Templates\StorageCDN.json',
    [string] $TemplateParametersFile = 'Templates\StorageCDN.parameters.json',
