...
#Restart-Service WinRm
    ...
    {
        Ensure = "Present"  
        Path  = "C:\Tools\WebDeploy_amd64_en-US.msi"
        Name = "Microsoft Web Deploy 3.6"
        ProductId = "{ED4CC1E5-043E-4157-8452-B5E533FE2BA1}"
        Arguments = "/passive ADDLOCAL=ALL LISTENURL=http://+:8080/"
